import VideoBlock from './../img/videos/videoBlock-design.webp'
import { VideoServiceContent } from '../data/SectionText';
                ...
                <div className="video__content">
                    <div className="video__preview preview-video">
                        ...
                        <div className="preview-video__info">
                            <h6 className="preview-video__name">{VideoServiceContent.h6}</h6>
                            <h5 className="preview-video__title">{VideoServiceContent.h5}</h5>
                        </div>
